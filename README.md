...
## アプリを体験する
以下のリンクよりHealthTrackerアプリを直接体験することができます。データを入力するだけで、相関分析と回帰分析を行います。AI（Gemini）とチャットする際はAPIキーが必要になります。
...
## バージョン情報
### バージョン1.0
- 初期リリース: 基本的なデータ取り込み、前処理、相関分析、回帰分析の機能を提供。

### バージョン1.1
- 新機能: Gemini AIとの対話機能を追加しました。
  - データ分析の結果を基にAIと対話し、詳細な分析結果やアドバイスを提供。
  - これにより、ユーザーは自分のデータに基づいてAIと対話し、個別のフィードバックを受け取ることができます。
